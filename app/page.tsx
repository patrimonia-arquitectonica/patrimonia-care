          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <button onClick={() => {
                  const params = new URLSearchParams({ miembro: miembro || "", comunidad: comunidad || "", area: area || "", espacio: espacio || "" });
            ...
            {/* Resumen rápido si hay miembro seleccionado */}
            {miembro && (
              <div className="bg-[#EEEDFE] rounded-2xl border border-[#AFA9EC] p-5">
                <p className="text-xs font-semibold uppercase tracking-widest text-[#534AB7] mb-3">Resumen</p>
                <div className="space-y-2">
                  ...
                  {comunidad && <div className="flex gap-2 text-sm"><span className="text-[#534AB7] font-medium w-20">Comunidad</span><span className="text-[#3C3489]">{comunidad}{area ? ` · ${area}` : ""}</span></div>}
