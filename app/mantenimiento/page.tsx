      ...
      <div className="min-h-screen bg-[#F5F4F0] flex flex-col items-center justify-start p-4">
        <div className="w-full max-w-sm bg-white rounded-3xl shadow-sm overflow-hidden">
          <div className="px-5 py-10 flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-sm text-gray-400">Ref. <span className="text-[#534AB7] font-semibold">#MNT-0052</span></p>
            ...
            <button onClick={() => { setGuardado(false); setCategoria(""); setDescripcion(""); setFecha(""); setComentario(""); }} className="w-full py-3 bg-[#EEEDFE] border border-[#534AB7] text-[#3C3489] rounded-xl text-sm font-semibold">
              + Crear otro registro
            </button>
      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div className="bg-[#EEEDFE] rounded-2xl p-4 space-y-2">
            <div className="flex gap-2 text-sm"><span className="text-[#534AB7] font-medium w-20">Persona</span><span className="text-[#3C3489]">Sara García</span></div>
            <div className="flex gap-2 text-sm"><span className="text-[#534AB7] font-medium w-20">Comunidad</span><span className="text-[#3C3489]">Viñuelas · L3</span></div>
            <div className="flex gap-2 text-sm"><span className="text-[#534AB7] font-medium w-20">Espacio</span><span className="text-[#3C3489]">Baño</span></div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-[#E1F5EE] border border-[#5DCAA5] rounded-xl px-3 py-2">
              <span className="text-sm">📧</span>
              <span className="text-xs text-[#085041]">Se enviará a facturas@patrimoniacare.com con ref. #MNT-0052</span>
            </div>
          </div>
